        ...
        <div className="w-full flex flex-row items-center gap-[12px] md:gap-[24px]">
          {valueItems.map((digit, index) => (
            <input
              ...
              {...otherProps}
              className="outline-none caret-bespokeGreen rounded-[8px] border-[1px] md:border-[2px] text-center border-[#7B7B7B80] focus:border-bespokeGreen h-[40px] md:h-[80px] w-[40px] md:w-[75px] valid:background-[#F8FBFA] text-[#006C33]"
            />
          ))}
        </div>
      </div>
