...
import Budgets from "../../views/pages/HR/Accounting/Budgets.tsx";
...
import EmployeeSalary from "../../views/pages/HR/Payroll/EmployeeSalary.tsx";
import PaySlip from "../../views/pages/HR/Payroll/Payslip";
import PayrollItems from "../../views/pages/HR/Payroll/PayrollItems.tsx";
...
import ScheduleTiming from "../../views/pages/Administration/Jobs/ScheduleTiming.tsx";
...
import Analytics from "src/views/pages/Crm/Analytics";
import Companies from "src/views/pages/Crm/companies";
import CompaniesGrid from "src/views/pages/Crm/CompaniesGrid";
import CompanyDetails from "src/views/pages/Crm/CompanyDetails";
import ContactDetails from "src/views/pages/Crm/ContactDetails";
import ContactGrid from "src/views/pages/Crm/ContactGrid";
import ContactList from "src/views/pages/Crm/ContactList";
import Deals from "src/views/pages/Crm/Deals";
import DealsDetails from "src/views/pages/Crm/DealsDetails";
import DealsKanban from "src/views/pages/Crm/DealsKanban";
import LeadsDetails from "src/views/pages/Crm/LeadsDetails";
import LeadsKanban from "src/views/pages/Crm/LeadsKanban";
import LeadsList from "src/views/pages/Crm/LeadsList";
import PipeLine from "src/views/pages/Crm/PipeLine";
import TicketDetails from "src/views/pages/Employees/TicketDetails";
import EmailView from "src/views/pages/MainPages/Apps/Email/emailView";
import DealsDashboard from "src/views/pages/MainPages/Dashboard/DealsDashboard";
import LeadsDashboard from "src/views/pages/MainPages/Dashboard/LeadsDashboard";
import Apexchart from "src/views/pages/Ui_Interface/Charts/Apexcharts";
import C3Charts from "src/views/pages/Ui_Interface/Charts/C3charts";
import ChartJs from "src/views/pages/Ui_Interface/Charts/Chartjs";
import FlotCharts from "src/views/pages/Ui_Interface/Charts/Flotcharts";
import MorrisCharts from "src/views/pages/Ui_Interface/Charts/Morrischarts";
import PeityCharts from "src/views/pages/Ui_Interface/Charts/Peitycharts";
import Counter from "src/views/pages/Ui_Interface/Elements/Counter";
import Dragdrop from "src/views/pages/Ui_Interface/Elements/Dragdrop";
import Formwizard from "src/views/pages/Ui_Interface/Elements/Formwizard";
import Scrollbar from "src/views/pages/Ui_Interface/Elements/Scrollbar";
import Stickynotes from "src/views/pages/Ui_Interface/Elements/Stickynote";
import Texteditor from "src/views/pages/Ui_Interface/Elements/Texteditor";
import FileUpload from "src/views/pages/Ui_Interface/Forms/FileUpload";
import FormSelectTwo from "src/views/pages/Ui_Interface/Forms/FormSelectTwo";
import FeatherIcons from "src/views/pages/Ui_Interface/Icons/Feathericons";
import FlagIcons from "src/views/pages/Ui_Interface/Icons/Flagicons";
import FontAwesomeicons from "src/views/pages/Ui_Interface/Icons/Fontawesomeicons";
import MaterialIcons from "src/views/pages/Ui_Interface/Icons/Materialicons";
import Pe7Icon from "src/views/pages/Ui_Interface/Icons/Pe7icons";
import SimpleLine from "src/views/pages/Ui_Interface/Icons/Simpleicons";
import Themifyicons from "src/views/pages/Ui_Interface/Icons/Themifyicons";
import Typicons from "src/views/pages/Ui_Interface/Icons/Typicons";
import WeatherIcons from "src/views/pages/Ui_Interface/Icons/Weathericons";
import Clipboard from "src/views/pages/Ui_Interface/Elements/Clipboard";
import Rating from 'src/views/pages/Ui_Interface/Elements/Rating';
import Notification from 'src/views/pages/Ui_Interface/Elements/Notification';
import IonicIcons from 'src/views/pages/Ui_Interface/Icons/Ionicicons';
...
const AppContainer = () => {
  ...
  const mobileResponsive = (event: any) => {
    const excludedHeader: any = document.querySelector(".header");
    const excludedSidebar: any = document.querySelector(".sidebar");
