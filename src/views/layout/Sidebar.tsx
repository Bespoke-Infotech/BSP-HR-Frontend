...
const Sidebar = () => {
  ...
  const activeRouterPath = (routesArray) => {
    // return (routesArray = Location.path);
        ...
        <div className="sidebar sidebar-twocol">
          <div className="sidebar-left slimscroll">
            ...
            >
              ...
              {/* <Link className="nav-link" id="v-pills-policies-tab" title="Policies" data-bs-toggle="pill" to="#v-pills-policies" role="tab" aria-controls="v-pills-policies" aria-selected="false">
