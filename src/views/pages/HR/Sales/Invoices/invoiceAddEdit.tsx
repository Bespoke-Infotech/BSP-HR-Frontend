...
const InvoiceAddEdit = () => {
  ...
  const [selectedOption, setSelectedOption] = useState<any>(options[1]);
  const [selectProjects, setselectProjects] = useState<any>(projects[0]);
  const [selectTax, setselectTax] = useState<any>(taxes[0]);
