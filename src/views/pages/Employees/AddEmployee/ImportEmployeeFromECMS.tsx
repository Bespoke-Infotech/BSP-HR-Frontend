...
const ImportEmployeeFromECMS = (props: IStepsInterface) => {
  ...
  return (
    ...
    >
      ...
      >
        <div>
          <h4 className="modal-title mb-4">Import from ECMS</h4>
          {/* <form> */}
          {files.length > 0 ? (
            <div
              style={{
...
export default ImportEmployeeFromECMS;
