...
const Clipboard = () => {
  ...
  const inputCopyRef: any = useRef(null);
  ...
  const textareaCopyRef: any = useRef(null);
  ...
  const advancedParagraphRef: any = useRef(null);
  const [copiedLink, setCopiedLink] = useState<any>(null);
  // eslint-disable-next-line no-unused-vars
  const [copiedHiddenCode, setCopiedHiddenCode] = useState<any>(null);
