...
const CompanyDetails = () => {
  ...
  useEffect(() => {
    ...
    const maximizeBtn:any = maximizeBtnRef.current;
                      ...
                      <div className="col-auto top-action-right">
                        <div className="text-end">
                          ...
                          <div className="btn-group">
                            <Link to="" className="btn btn-white"><i className="fa-solid fa-angle-left" /></Link>
                            <Link to="" className="btn btn-white"><i className="fa-solid fa-angle-right" /></Link>
                          </div>
                        </div>
                        <div className="text-end">
