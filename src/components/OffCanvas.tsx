...
const OffCanvas = () => {
  ...
  const getlayoutWidth:any = localStorage.getItem("layoutwidth");
  ...
  const Vertical = () => {
    ...
    const VeriticalLayout:any = document.querySelector("html");
  ...
  const TwoColumn = () => {
    ...
    const TwoColumnLayout:any = document.querySelector("html");
    // document.querySelector("#horizantal-sidebar").style.display = "none";
    // document.querySelector("#veritical-sidebar").style.display = "none";
  ...
  const OrangeThemes = () => {
    ...
    const OrangesThemes:any = document.querySelector("html");
  ...
  const DarkThemes = () => {
    ...
    const DarksThemes:any = document.querySelector("html");
  ...
  const LightThemes = () => {
    ...
    const LightsThemes:any = document.querySelector("html");
    LightsThemes.setAttribute("data-layout-mode", "light");
  };
  const BlueThemes = () => {
    localStorage.setItem("colorschema", "blue");

    const BluesThemes:any = document.querySelector("html");
  ...
  const MaroonThemes = () => {
    ...
    const MaroonsThemes:any = document.querySelector("html");
  ...
  const ScrollBar = () => {
    ...
    const ScrollBarThemes:any = document.querySelector("html");
  ...
  const Fixed = () => {
    ...
    const FixedThemes:any = document.querySelector("html");
    FixedThemes.setAttribute("data-layout-position", "fixed");
  };
  const PurpleThemes = () => {
    localStorage.setItem("colorschema", "purple");

    const PurplesThemes:any = document.querySelector("html");
  ...
  const LightBarThemes = () => {
    ...
    const LightBarsThemes:any = document.querySelector("html");
    LightBarsThemes.setAttribute("data-topbar", "light");
    LightBarsThemes.setAttribute("data-sidebar", "dark");
  };
  const DarkBarThemes = () => {
    localStorage.setItem("topbartheme", "dark");
    const DarkBarsThemes:any = document.querySelector("html");
  ...
  const Fluid = () => {
    ...
    const FluidThemes:any = document.querySelector("html");
  ...
  const BoxThemes = () => {
    ...
    const BoxsThemes:any = document.querySelector("html");
  ...
  const DarkStyle = () => {
    ...
    const DarkStylesThemes:any = document.querySelector("html");
    DarkStylesThemes.setAttribute("data-sidebar", "dark");
  };
  const GradientStyle = () => {
    localStorage.setItem("layoutSidebarStyle", "gradient");
    const GradientsThemes:any = document.querySelector("html");
