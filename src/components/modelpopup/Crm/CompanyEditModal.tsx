...
const CompanyEditModal = () => {
    const [fieldOne, setFieldOne] = useState<any>(true);
    const [fieldTwo, setFieldTwo] = useState<any>();
    const [fieldThree, setFieldThree] = useState<any>();
    const [fieldFour, setFieldFour] = useState<any>();
                                        ...
                                        <div className="form-upload-profile">
                                            ...
                                            <div className="profile-pic-upload">
                                                <div className="profile-pic">
                                                    <span><img src={avatar19} className="rounded-circle" alt="Img" /></span>
                                                </div>
